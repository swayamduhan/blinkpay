        ...
        <section className="min-h-screen mb-20" id="get-started-section">
            <div id="get-started-wrapper" className="p-10 pt-20 space-y-20">
                ...
                <div id="get-started-content" className="grid grid-cols-3">
                    <div className="col-span-1 text-6xl space-y-10">
                        <div id="text-1" className="leading-[65px] -space-y-2">
                            ...
                            <span className="text-purple-700 relative group cursor-pointer border border-transparent">
                                <div className="w-8 h-8 absolute -right-5 -top-0 group-hover:-right-6 group-hover:-top-1 transition-all duration-300">
                                    <ArrowTopRight />
                                </div>
                                Signup
                            </span>
                        ...
                        <div id="text-2" className="leading-[65px] -space-y-2">
                            Experience the interface designed for humans
                        </div>
                    </div>
                    <div className="col-span-2 h-[75vh] relative">
                        <InteractiveMock />
                        <div id="dash-mockup" className="w-[80%] rounded-3xl overflow-hidden absolute bottom-0 right-0 border-4 border-pastel-300/50 shadow-xl shadow-pastel-300/20 hover:scale-[1.01] transition-all duration-300 ease-out">
